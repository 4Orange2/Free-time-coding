...
myLayers model =
  ...
  , animal_animation model 0 lion
  |> move(0, model.time * (-50))
  |> withDepth size
  
  , animal_animation model 1 frog
  |> move(0, (model.time - 4) * (-50))
  |> withDepth size
  
  , animal_animation model 2 sheep
  |> move(0, (model.time - 8) * (-50))
  |> withDepth size
  
  , animal_animation model 3 bird
  |> move(0, (model.time - 12) * (-50))
  |> withDepth size
  
  , animal_animation model 4 panther
  |> move(0, (model.time - 16) * (-50))
  |> withDepth size
  ...
  |> withDepth 300
  , textanimation model 0 "Once upon a time" 100
  |> withDepth 300
  , textanimation model 0.2 "There was a lion" 85
  |> withDepth 300
  , textanimation model 1 "A frog" 70
  |> withDepth 300
  , textanimation model 2 "A sheep" 55
  |> withDepth 300
  , textanimation model 3 "A bird" 40
  |> withDepth 300
  , textanimation model 4 "And a panther" 25
  |> withDepth 300
  , textanimation model 5 "And they all lived happily ever after" 10
  |> withDepth 300
  , textanimation model 6 "THE END" -5
  |> withDepth 300
  ]
